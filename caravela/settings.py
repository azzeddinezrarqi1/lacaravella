...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-7_ivv)6&0@7$4wd=0@m1fe9yfepq(%52cb9@#b31pg=b0t-cuv')
...
# Cacheops configuration (désactivé pour l'instant)
...
# Configuration Django Allauth pour la déconnexion
...
KLAVIYO_API_KEY = config('KLAVIYO_API_KEY', default='')
